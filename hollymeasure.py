...
class HollyMeasurer(od.WormMeasurer):
	...
	def measure_gfp_fluorescence(self,fluorescent_image, worm_mask, time_series):
		...
		percentile95_mask=(fluorescent_image>percentile95)& worm_mask
		...
		colored_areas = extractFeatures.color_features([expression_mask,high_expression_mask,percentile95_mask])	
